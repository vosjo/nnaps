...
class TestProcessorConversion(unittest.TestCase):
   ...
   def test_standardScaler(self):  
      ...
      np.testing.assert_almost_equal(data, inv_data,
                      err_msg="data transformed by original and inverse transformed by loaded scaler does not equal original data.")
   ...
   def test_oneHotEncoder(self):  
      ...
      np.testing.assert_equal(data, inv_data,
                      err_msg="data transformed by original and inverse transformed by loaded encoder does not equal original data.")
...
class TestSafeLoadModel(unittest.TestCase):
   ...
   def test_saveLoad_processors(self):
      ...
      np.testing.assert_equal(data['kwargs']['categories_'][0], np.array(data_new['kwargs']['categories_'][0], dtype='<U5'))
